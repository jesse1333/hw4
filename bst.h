...
public:
    ...
    void print() const;
    bool empty() const;
    void recursiveClearHelper(Node<Key, Value> *node);
...
protected:
    ...
    Node<Key, Value> *removeHelper(Node<Key, Value> *root, const Key &key);
    Node<Key, Value> *getSuccessor(Node<Key, Value> *root);
...
BinarySearchTree<Key, Value>::iterator::operator++()
{
    ...
    {
        // if the current node has a right child, iterate to the leftmost node of the right subtree
    ...
    {
        // if not, go up the tree until we find a node of the left child of its parent
...
void BinarySearchTree<Key, Value>::insert(const std::pair<const Key, Value> &keyValuePair)
{
    ...
    while (currentNode != nullptr)
    {
        ...
        // if node is less, left traversal
        ...
        // if node is greater, right traversal
        ...
        // if the node is equal, update the value
        else
        {
...
{
    // TODO
    Node<Key, Value> *currentNode = internalFind(key);
    ...
    {
        Node<Key, Value> *predecessor = currentNode->getLeft();
        while (predecessor->getRight() != nullptr)
        {
            predecessor = predecessor->getRight();
        }

        nodeSwap(currentNode, predecessor);
    }

    // if root has no children
    Node<Key, Value> *parentNode = currentNode->getParent();
    Node<Key, Value> *child = currentNode->getLeft();
...
BinarySearchTree<Key, Value>::predecessor(Node<Key, Value> *current)
{
    ...
    {
        Node<Key, Value> *predecessor = current->getRight();
        while (predecessor->getLeft())
        {
...
void BinarySearchTree<Key, Value>::clear()
{
    ...
    recursiveClearHelper(root_);
    root_ = nullptr;
}

// Helper function to clear node
template <typename Key, typename Value>
void BinarySearchTree<Key, Value>::recursiveClearHelper(Node<Key, Value> *node)
{
    if (node == nullptr)
    {
        return;
    ...
    recursiveClearHelper(node->getLeft());
    recursiveClearHelper(node->getRight());
...
Node<Key, Value> *BinarySearchTree<Key, Value>::getSmallestNode() const
{
    ...
    // keeps going down the left subtree to get smallest node
...
Node<Key, Value> *BinarySearchTree<Key, Value>::internalFind(const Key &key) const
{
    ...
    while (currentNode != nullptr)
    {
        ...
        // if the node is equal, means we found it
        else
        {
            return currentNode;
        }
...
int treeHeight(Node<Key, Value> *root)
{
    ...
    else
    {
        ...
        // Compare left and right heights and return the maximum
...
bool isBalancedHelper(Node<Key, Value> *root)
{
    ...
    if (abs(leftHeight - rightHeight) <= 1 && isBalancedHelper(root->getLeft()) && isBalancedHelper(root->getRight()))
    {
        return true;
    }
    else
